...
export class RegisterComponent implements OnInit {
  ...
  // showSetPasswordPage(data:any){
  //   this.userService.setPasswordPage(data["token"]).subscribe((response)=>{
  //     if(response==201){
  //       this.router.navigate(['set-password'],{ queryParams: { token: data["token"] } })
  //     }
  //   })
  // }
}
